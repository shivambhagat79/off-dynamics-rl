...
class NOMAD_V2(object):
    ...
    def train(self, src_replay_buffer, tar_replay_buffer, initial_state, batch_size=128, writer=None):
        ...
        with torch.no_grad():
            ...
            _, log_prob_src_policy, _ = self.policy(tar_state_is, get_logprob=True)
            _, log_prob_tar_policy, _ = self.target_policy(tar_state_is, get_logprob=True)
