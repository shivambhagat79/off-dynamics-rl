...
# ... [Classes TanhTransform, MLPNetwork, Policy, DoubleQFunc, Classifier remain unchanged] ...
...
class NOMAD_IDBM(object):
    ...
    def _update_liberty_models(self, src_data, tar_data, writer):
        ...
        # (We prioritize target dynamics for the forward model to handle target exploration)
        ...
        # Update metric model
        # LOGIC CHANGE: Compare Source states to Target states for Bisimulation
        # This aligns the metric across the domain gap.

        # Use Source data as "state" and Target data as "state_p"
        ...
        with torch.no_grad():
            ...
            # Compares the distribution of next states in Source vs Target
    ...
    def train(self, src_replay_buffer, tar_replay_buffer, initial_state, batch_size=128, writer=None):
        ...
        # Sample data from BOTH Source and Target
        ...
        # LOGIC CHANGE: Pass both data tuples to the update function
